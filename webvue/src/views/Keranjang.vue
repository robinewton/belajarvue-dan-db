...
export default {
  ...
  methods: {
    ...
    hapusKeranjang(id) {
      axios
        .delete("http://localhost:2000/keranjangs/" + id)
        .then(() => {
          ...
          axios
            .get("http://localhost:2000/keranjangs")
    ...
    checkout() {
      if (this.pesan.nama && this.pesan.noMeja) {
        ...
        axios
          .post("http://localhost:2000/pesanans", this.pesan)
          .then(() => {

            // Hapus Semua Keranjang 
            this.keranjangs.map(function (item) {
              return axios
                .delete("http://localhost:2000/keranjangs/" + item.id)
                .catch((error) => console.log(error));
            });
